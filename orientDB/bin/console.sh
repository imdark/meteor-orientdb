...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-2.1-rc5.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
"$JAVA" -client $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS -Dfile.encoding=utf-8 -Dorientdb.build.number="UNKNOWN@r${buildNumber}; 2015-07-03 13:03:30+0000" -cp "$ORIENTDB_HOME/lib/orientdb-tools-2.1-rc5.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" com.orientechnologies.orient.graph.console.OGremlinConsole $*
